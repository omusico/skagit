	...
	<div class="row-fluid">    
     ...
     <div class="row-fluid">    
	  	<div class="span6"> 	
    			...
    			<p>	
    			Would you like us to send you information about promotions and upcoming events?
    				<br>
    				<label class="radio inline">
						<input type="radio" name="add-to-mailing-list" id="mailing-list-yes" value="yes" checked>
Yes
					</label>
					<label class="radio inline">
						<input type="radio" name="add-to-mailing-list" id="mailing-list-no" 			value="no">
No
					...
					If so, how do you prefer to receive the information?
					<br>
    				<label class="radio inline">
						<input type="radio" name="mail-preference" id="prefer-email" value="prefer-email" checked>
email
					</label>
					<label class="radio inline">
						<input type="radio" name="mail-preference" id="prefer-regular-mail" 			value="prefer-regular-mail">
regular mail
					</label>
				</p>	
