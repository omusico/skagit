	...
	<div class="row-fluid">    
	  <div class="span12">
	  	...
	  	<h1>Careers <small></small></h1>
        	...
        	<p><b>* Please note: Due to the high number of career inquiries, we cannot respond to every one. Inquiries with cover letters and resumes will be given preference.</b></p>
        	<br><br>
     		...
     		<form name="careerForm" id="careerForm" action="/webformmailer.php" method="post" class="form-horizontal">
